...
import AiLimitBadge from '@/components/AiLimitBadge';
...
export default function Chatbot() {
  ...
  useEffect(() => {
    ...
    try {
      ...
      socketInstance.on('limit reached', (data: { error: string, message: string }) => {
        console.log('AI limit reached:', data.message);
  ...
  const handleSendMessage = (e: React.FormEvent) => {
    ...
    if (limitReached) {
      setConnectionError("You have reached your AI prompt limit. Please contact support for more information.");
      return;
    }
