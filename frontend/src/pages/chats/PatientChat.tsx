          ...
          <div className="max-w-6xl mx-auto">
            <div className="flex items-center mb-4 sm:mb-6">
              <Button 
                variant="ghost" 
                size="sm"
                className="mr-2 sm:mr-4 rounded-full hover:bg-blue-100 text-blue-600 p-2 sm:p-3"
              ...
              <div className="flex items-center min-w-0 flex-1">
                ...
                <div className="min-w-0 flex-1">
                  <h1 className="text-lg sm:text-xl font-bold text-gray-900 truncate">{chat.doctor.name}</h1>
                  <div className="flex items-center text-gray-600 mt-1">
                    <span className="flex items-center text-xs sm:text-sm bg-blue-100 text-blue-700 px-2 py-0.5 rounded-full">
                      ...
                      <span className="truncate">{chat.doctor.doctor?.speciality || 'Doctor'}</span>
                    </span>
                  </div>
                </div>
              </div>
